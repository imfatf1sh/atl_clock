...
import com.android.deskclock2.FabContainer;
import com.android.deskclock2.FormattedTextUtils;
import com.android.deskclock2.R;
import com.android.deskclock2.ThemeUtils;
import com.android.deskclock2.uidata.UiDataModel;

import java.io.Serializable;
import java.util.Arrays;

import static com.android.deskclock2.FabContainer.FAB_REQUEST_FOCUS;
import static com.android.deskclock2.FabContainer.FAB_SHRINK_AND_EXPAND;
...
public class TimerSetupView extends LinearLayout implements View.OnClickListener,
    ...
    protected void onFinishInflate() {
        ...
        final int colorControlDisabled = ThemeUtils.resolveColor(dividerContext,
                androidx.appcompat.R.attr.colorControlNormal, new int[] { ~android.R.attr.state_enabled });
